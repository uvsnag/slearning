    ...
    <div className="App">
      <ul className="mst-menu">
        <li className="mst-menu-li">
          <Link href="/slearning/notify">Notify</Link>
        </li>
        <li className="mst-menu-li">
          <Link href="/slearning/youtube-sub">YT-Sub</Link>
        </li>
        <li className="mst-menu-li">
          <Link href="/slearning/next-sent">Next-Sentence</Link>
        </li>
        <li className="mst-menu-li">
          <Link href="/slearning/listen">Listen Word Prac</Link>
        </li>
        <li className="mst-menu-li">
          <Link href="/slearning/listenTens">Listen Passage Prac</Link>
        </li>
        <li className="mst-menu-li">
          <Link href="/slearning/voiceToText">Speed To Text</Link>
        </li>
        <li className="mst-menu-li">
          <Link href="/slearning/dash-board1">Board1</Link>
        </li>
        {/* <li className="mst-menu-li">
          <Link href="/slearning/ai">AI</Link>
        </li> */}
