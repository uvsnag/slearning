...
<details class="viet-answer"><summary>🇻🇳 Đáp án (Tiếng Việt)</summary><p>Đây là ba mức khóa một object. <code>preventExtensions</code> chặn việc thêm thuộc tính mới, <code>seal</code> chặn thêm cả việc xóa thuộc tính, còn <code>freeze</code> chặn thêm cả việc thay đổi giá trị, nên một object đã freeze là chỉ đọc. Cả ba đều nông (shallow), nên các object lồng nhau vẫn có thể thay đổi và cần một deep freeze đệ quy để bảo vệ hoàn toàn. Các thao tác bị chặn sẽ thất bại một cách âm thầm trừ khi code chạy trong strict mode.</p></details>
<table style="width:100%;border-collapse:collapse;margin:10px 0;font-size:.88rem;">
